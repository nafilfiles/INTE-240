const lyrics = [
    ...
    { time: 4, voice: "w", text: "I need a break beat, uh" },
    ...
    // Verse two
    { time: 37, voice: "w", text: "Steve walks wearily down the street" },
    { time: 38.4, voice: "w", text: "With the brim pulled way down low" },
...
const lyricElementthird = document.getElementById("lyric-third");
const voiceElementoth = document.getElementById("voice-others");
const voiceElementthird = document.getElementById("voice-third");
